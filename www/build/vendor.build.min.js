...
/* $arrayJS: obedm503-array 1.0.0 git:https://github.com/obedm503/obedm503-array 03-08-2016 */
"use strict";!function(a){function b(){function a(a){return a&&Array.isArray(a)?function(b){if(b&&"string"==typeof b){var c=!1;return a.forEach(function(a){a[b]&&(c=!0)}),c}return void console.error(j+"no correct key given")}:void console.error(j+"no correct array given")}function b(b){return b&&Array.isArray(b)?function(c,d){if(c&&a(b)(c)){var e={},f=[];return b.map(function(a){return e={},f.indexOf(a[c])<0?(f.push(a[c]),d?e[d]=a[c]:e[c]=a[c],e):void 0}).filter(function(a){return a&&"{}"!==JSON.stringify(a)})}return void console.error(j+'"'+c+'" is not a key in array')}:void console.error(j+"param is not array")}function c(a){if(a&&Array.isArray(a)){for(var b=0;b<a.length/2;b+=1){var c=a.length-1-b,d=a[b];a[b]=a[c],a[c]=d}return a}return void console.error(j+"no correct array given")}function d(a){if(a&&Array.isArray(a)){for(var b,c,d=a.length;0!==d;)c=Math.floor(Math.random()*d),d-=1,b=a[d],a[d]=a[c],a[c]=b;return a}return void console.error(j+"no correct array given")}function e(b){return b&&Array.isArray(b)?function(c){return c&&a(b)(c)?b.sort(i(c)):void console.error(j+"no correct key given")}:void console.error(j+"no correct array given")}function f(b){return b&&Array.isArray(b)?function(c){return c&&a(b)(c)?b.sort(i("-"+c)):void console.error(j+"no correct key given")}:void console.error(j+"no correct array given")}function g(b){return b&&Array.isArray(b)?function(c){if(c&&a(b)(c)){for(var d={},e=!0,f=0,g=b.length;f<g;f++)b[f][c]?d[b[f][c]]=b[f]:e=!1;return e?d:void console.error(j+"key not found")}return void console.error(j+"bad params")}:void console.error(j+"no correct array given")}function h(a){return function(b){return a.reduce(function(a,c){var d=[];return b.forEach(function(a,b){a(c)&&d.push(b)}),0===d.length?a[a.length-1].push(c):d.forEach(function(b){return a[b].push(c)}),a},Array.apply(null,{length:b.length+1}).map(function(a){return[]}))}}function i(a){var b=1;return"-"===a[0]&&(b=-1,a=a.substr(1)),function(c,d){var e=c[a]<d[a]?-1:c[a]>d[a]?1:0;return e*b}}var j="$arrayJS: ",k={keyExists:a,filterByKey:b,reverse:c,sortRandom:d,sortAscend:e,sortDescend:f,convertToObject:g,groupObjects:h};return k}"undefined"==typeof $array&&(a.$array=b())}(window);