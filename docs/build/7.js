...
var Login = (function () {
    function Login(events, nav, navParams, auth, store, state, alert, loadingCtrl, translate, log, menuCtrl) {
        this.events = events;
        this.nav = nav;
