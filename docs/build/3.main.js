...
var Profile = (function () {
    ...
    Profile.prototype.ionViewDidLoad = function () {
        ...
        this.store.get('IMAGE').then(function (img) {
            if (img === void 0) { img = ''; }
            console.log('dismiss');
            _this.personImage = img ? "data:image/jpeg;base64," + img : './assets/placeholder.jpg';
